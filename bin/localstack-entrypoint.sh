...
readonly LOCALSTACK_SNS_URL=http://localstack:4575
sleep 5;
...
aws --endpoint-url=$LOCALSTACK_SNS_URL sns create-topic --name local_sns
# Subscribing to SNS to SQS
aws --endpoint-url=$LOCALSTACK_SNS_URL sns subscribe --topic-arn arn:aws:sns:us-east-1:000000000000:local_sns --protocol sqs --notification-endpoint http://localstack:4576/queue/blockchain-local-engine-cancel
